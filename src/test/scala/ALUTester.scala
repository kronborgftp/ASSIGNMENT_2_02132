...
class ALUTester extends AnyFlatSpec with ChiselScalatestTester {
  ...
  "ALU" should "perform 16-bit arithmetic and logic operations correctly" in {
    ...
    test(new ALU()) { dut =>
      ...
      dut.io.a.poke(10.U)
      dut.io.b.poke(3.U)
      dut.io.sel.poke("b0000".U)  // ADD opcode
      dut.clock.step(1)
      ...
      dut.io.a.poke(10.U)
      dut.io.b.poke(3.U)
      dut.io.sel.poke("b0001".U)  // SUB opcode
      dut.clock.step(1)
      ...
      dut.io.a.poke(10.U)
      dut.io.b.poke(3.U)
      dut.io.sel.poke("b0010".U)  // OR opcode
      dut.clock.step(1)
      ...
      dut.io.a.poke(10.U)
      dut.io.b.poke(3.U)
      dut.io.sel.poke("b0011".U)  // AND opcode
      dut.clock.step(1)
      dut.io.out.expect((10 & 3).U)
      ...
      dut.io.sel.poke("b0100".U)     // NOT opcode
      dut.clock.step(1)
      ...
      dut.io.a.poke(10.U)
      dut.io.b.poke(3.U)
      dut.io.sel.poke("b0101".U)  // GT opcode
      dut.clock.step(1)
      ...
      dut.io.a.poke(10.U)
      dut.io.b.poke(3.U)
      dut.io.sel.poke("b0110".U)  // MOD opcode
      dut.clock.step(1)
      dut.io.out.expect((10 % 3).U)
      ...
      dut.io.a.poke(5.U)
      dut.io.b.poke(5.U)
      dut.io.sel.poke("b0001".U)  // SUB (5 - 5 = 0)
      dut.clock.step(1)
